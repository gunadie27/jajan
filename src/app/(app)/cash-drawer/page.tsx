                                ...
                                <div className="space-y-4 py-4">
                                    <Card className="bg-muted/50">
                                        <CardContent className="p-4 space-y-2">
                                            ...
                                            <div className="flex justify-between"><span className="text-muted-foreground">(+) Penjualan Tunai</span> <span>{formatCurrency(sessionData.cashSales)}</span></div>
                                            <div className="flex justify-between"><span className="text-muted-foreground">(-) Pengeluaran</span> <span>{formatCurrency(sessionData.totalExpenses)}</span></div>
                                            <div className="flex justify-between font-bold pt-2 border-t"><span >Uang Tunai Seharusnya</span> <span>{formatCurrency(sessionData.calculatedCash)}</span></div>
                                        </CardContent>
                                    </Card>
